...
{ 
  ...
  char recvChar;
   ...
   Serial.println ("Press GO button to continue");
   nxshield.waitForButtonPress(BTN_GO);
   Serial.println ("Streaming BT Data ...");
    while(1){
      /* 
...
{
  blueToothSerial.begin(38400); //  9600, 19200, 38400, 57600, 115200, 230400, 460800   Set BluetoothBee BaudRate to default baud rate 38400
